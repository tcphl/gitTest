...
public class BaseDaoImpl implements IBaseDao {
    ...
    public int update(String tableName, Map<String, Object> params) {
        ...
        for (String key : keySet){
            ...
            if("null".equals(value+"")){
                ...
                sb.append(key +" = '" +new SimpleDateFormat(Code.DATE_FORMAT_DEFAULT).format(value)+"' ,");
            }else if(value == null){
                sb.append(key +" = null ,");
            }
        }
    ...
    public long save(String tableName, Map<String, Object> params) {
        ...
        for (String key: keySet) {
            ...
            if(value instanceof String){
                ...
                sb.append(" '"+new SimpleDateFormat(com.shop.model.Code.DATE_FORMAT_DEFAULT).format(value)+"',");
            }
        }
    ...
    public PageModel findPage(String coloumSql, String fromSql, Integer pageNum, Integer pageSize) {
        ...
        pageSize = pageSize == null ? Code.PAGESIZE : pageSize;//为空设置默认
